...
!function (t, i, n, s) {
    ...
    e.prototype = {
        defaults: {
            ...
            t("html, body").animate({scrollTop: s - 150}, this.config.scrollSpeed, this.config.easing, n)
...
!function (a, b) {
    ...
    i.prototype = {
        ...
        return this.length > 1 && (i instanceof a || "object" == typeof i && null != i && i.tagName) && !k && m && console.log(c), this.each(function () {
            ...
            e ? g ? c = !0 : m : c = !0, c && (f = new a.Tooltipster(this, b[0]), e || (e = []), e.push(f.__namespace), d.data("tooltipster-ns", e), d.data(f.__namespace, f), f.__options.functionInit && f.__options.functionInit.call(f, f, {origin: this}), f._trigger("init")), a.tooltipster.__instancesLatestArr.push(f)
        }), this
    }, b.prototype = {
        __init: function (b) {
    ...
    -1 != j.indexOf("msie") ? h.IE = parseInt(j.split("msie")[1]) : -1 !== j.toLowerCase().indexOf("trident") && -1 !== j.indexOf(" rv:11") ? h.IE = 11 : -1 != j.toLowerCase().indexOf("edge/index.html") && (h.IE = parseInt(j.toLowerCase().split("edge/index.html")[1]));
